    ...
    <ul class="pcoded-item pcoded-left-item">
        ...
        <li class="pcoded-hasmenu  ">
            ...
            <ul class="pcoded-submenu">
                <li class="">
                    <a href="index.html" class="waves-effect waves-dark">
                        <span class="pcoded-mtext">Creat Survey</span>
                    </a>
                </li>
                <li class="">
            ...
            <ul class="pcoded-submenu">
                <li class="">
                    <a href="{{ route('category.create') }}" class="waves-effect waves-dark">
                        <span class="pcoded-mtext">Creat Category</span>
                    </a>
                </li>
                <li class="">
        ...
        <li class="pcoded-hasmenu  ">
            ...
            <ul class="pcoded-submenu">
                <li class="">
                    <a href="{{ route('question.create') }}" class="waves-effect waves-dark">
                        <span class="pcoded-mtext">Creat Question</span>
                    </a>
                </li>
                <li class="">
