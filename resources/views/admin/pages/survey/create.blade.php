                ...
                <div class="page-body">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="post" action="{{ route('survey.store') }}" novalidate="">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-12 col-xl-6 m-b-30">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Survey Name</label>
                                            <div class="col-sm-8">
                                                <input class="form-control" id="name" name="name" placeholder="Enter survey Name" type="text" value="{{ old('name') }}">
                                       ...
                                       <div class="form-group row">
                                            ...
                                            <div class="col-sm-1">
                                                <input class="form-control" id="status" name="status" type="checkbox" value="1">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        {{-- <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2" style="margin:5px;">
                                                <a href="{{ route('survey.index') }}"  class="btn btn-danger m-b-0">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-xl-4 m-b-30">
                                        <h4 class="sub-title">Select Zone</h4>
                                        <select id='optgroup'class="searchable" multiple='multiple' name="zone[]"
