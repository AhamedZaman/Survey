                ...
                <div class="page-body">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <form id="main" method="post" action="{{ route('category.update', $edits->id) }}" novalidate="">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-12 col-xl-6 m-b-30">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="name" name="name" type="text" value="{{ $edits->name }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="slug" name="slug"  type="text" value="{{ $edits->slug }}">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="description" name="description" type="text" value="{{ $edits->description }}">
                                                <span class="messages"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-radio" >
                                                        <div class="radio radio-inline" id="status">
                                                                <label>
                                                                    <input type="radio" id="active" name="status" value="1" {{ $edits->status == 1? "checked":"" }}>
                                                                    <i class="helper"></i>Active
                                                                </label>
                                                            </div>
                                                            <div class="radio radio-inline">
                                                                <label>
                                                                    <input type="radio" id="deactive" name="status" value="0" {{ $edits->status == 0? "checked":"" }}>
