...
<div class="page-header card">
    <div class="row align-items-end">
        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <a href="{{ route('category.create') }}"><button class="btn btn-success btn-round waves-effect waves-light"><i class="ti-pencil-alt"></i> Create Category</button></a>
            </div>
        </div>
    </div>
</div>
                                        ...
                                        <tbody>
                                            @foreach ($categories as $category)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('category.edit', $category->id) }}"><button class="btn waves-effect waves-light btn-success btn-icon"><i class="ti-pencil"></i></button></a>
